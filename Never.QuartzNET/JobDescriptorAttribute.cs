...
{
    /// <summary>
    /// Job特性描述，用于绑定Job工作定时器
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true, Inherited = false)]
    public class JobDescriptorAttribute : Attribute
    {
        /// <summary>
        /// Job名字
        /// </summary>
        ...
        /// 如果15号正好是周六，则找最近的周五(14号)触发, 如果15号是周未，则找最近的下周一(16号)触发.如果15号正好在工作日(周一至周五)，则就在该天触发。如果指定格式为 "1W",它则表示每月1号往后最近的工作日触发。
        ...
        /// <summary>
        /// 工作Id，通常不用填写，如果一个Job有多个事件调度，则要填写这个Id
        /// </summary>
