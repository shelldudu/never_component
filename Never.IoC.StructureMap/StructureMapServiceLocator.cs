...
namespace Never.IoC.StructureMap
{
    ...
    /// 注册组件接口实现对象
    /// </summary>
    public sealed class StructureMapServiceLocator : IServiceLocator, IServiceActivator
    {
        #region field
        ...
        /// 容器
        /// </summary>
        private readonly IStructureMapContainer rootScope = null;
        ...
        public StructureMapServiceLocator(IStructureMapContainer rootScope)
        {
        ...
        {
            return new StructureMapLifetimeScope(this.rootScope.CreateChildContainer());
        }
        ...
        /// </summary>
        /// <returns></returns>
        private ILifetimeScope BeginLifetimeScope(IStructureMapContainer scope, ILifetimeScopeTracker scopeTracker = null)
        {
            return (scopeTracker ?? ContainerContext.Current.ScopeTracker).StartScope(new StructureMapLifetimeScope(scope));
        }
        ...
        /// <param name="scopeTracker">scopeTracker</param>
        /// <returns></returns>
